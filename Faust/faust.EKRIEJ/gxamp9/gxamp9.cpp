...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("12ax7 feedback");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec7[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec8[0] + fRec8[2])) + (fRec10[0] + (1.8508997f * fRec8[1]))) + -0.840701997f)))) + -147.475372f);
			...
			fRec18[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec19[0] + fRec19[2])) + (fRec21[0] + (1.8508997f * fRec19[1]))) + -1.20428503f)))) + -169.71434f);
			...
			fRec23[0] = (float(Ftube(int(TUBE_TABLE_12AX7_68k), float((((0.925449848f * (fRec24[0] + fRec24[2])) + (fRec48[0] + (1.8508997f * fRec24[1]))) + -1.58165598f)))) + -191.420151f);
			...
			fRec12[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec13[0] + fRec13[2])) + (fRec50[0] + (1.8508997f * fRec13[1]))) + -1.20428503f)))) + -169.71434f);
			...
			fRec1[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec2[0] + fRec2[2])) + (fRec51[0] + (1.8508997f * fRec2[1]))) + -0.840701997f)))) + -147.475372f);
