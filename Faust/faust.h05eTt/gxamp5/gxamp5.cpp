...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("id", "pre 12ax7/ master 6V6");
		...
		m->declare("name", "pre 12ax7/ master 6V6");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("pre 12ax7/ master 6V6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec23[0] = (float(Ftube(int(TUBE_TABLE_12AX7_68k), float((((0.925449848f * (fRec24[0] + fRec24[2])) + (fRec27[0] + (1.8508997f * fRec24[1]))) + -1.58165598f)))) + -191.420151f);
			...
			fRec18[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec19[0] + fRec19[2])) + (fRec28[0] + (1.8508997f * fRec19[1]))) + -1.20428503f)))) + -169.71434f);
			...
			fRec14[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec15[0] + fRec15[2])) + (fRec29[0] + (1.8508997f * fRec15[1]))) + -0.840703011f)))) + -147.47525f);
