...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("6DJ8 feedback");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec7[0] = (float(Ftube(int(TUBE_TABLE_6DJ8_250k), float((((0.925449848f * (fRec8[0] + fRec8[2])) + (fRec10[0] + (1.8508997f * fRec8[1]))) + -0.797043025f)))) + -32.799633f);
			fRec6[0] = ((0.0500000007f * ((fConst4 * fRec7[0]) + (fConst11 * fRec7[1]))) - (fConst12 * fRec6[1]));
			...
			fRec18[0] = (float(Ftube(int(TUBE_TABLE_6DJ8_250k), float((((0.925449848f * (fRec19[0] + fRec19[2])) + (fRec21[0] + (1.8508997f * fRec19[1]))) + -1.27160895f)))) + -45.2260666f);
			fRec17[0] = ((0.0500000007f * ((fConst4 * fRec18[0]) + (fConst11 * fRec18[1]))) - (fConst12 * fRec17[1]));
			...
			fRec23[0] = (float(Ftube(int(TUBE_TABLE_6DJ8_68k), float((((0.925449848f * (fRec24[0] + fRec24[2])) + (fRec48[0] + (1.8508997f * fRec24[1]))) + -1.86394596f)))) + -60.964962f);
			fRec22[0] = ((0.0500000007f * ((fConst4 * fRec23[0]) + (fConst11 * fRec23[1]))) - (fConst12 * fRec22[1]));
			...
			fRec12[0] = (float(Ftube(int(TUBE_TABLE_6DJ8_250k), float((((0.925449848f * (fRec13[0] + fRec13[2])) + (fRec50[0] + (1.8508997f * fRec13[1]))) + -1.27160895f)))) + -45.2260666f);
			fRec11[0] = ((0.0500000007f * ((fConst4 * fRec12[0]) + (fConst11 * fRec12[1]))) - (fConst12 * fRec11[1]));
			...
			fRec1[0] = (float(Ftube(int(TUBE_TABLE_6DJ8_250k), float((((0.925449848f * (fRec2[0] + fRec2[2])) + (fRec51[0] + (1.8508997f * fRec2[1]))) + -0.797043025f)))) + -32.799633f);
			fRec0[0] = ((0.0500000007f * ((fConst4 * fRec1[0]) + (fConst11 * fRec1[1]))) - (fConst12 * fRec0[1]));
