...
tubec(preamp,gain1) = hgroup("amp2", hgroup("stage1", stage1) :
    ...
    lowpass(1,6531.0) : *(preamp) : tubestage(1,132.0,1500.0);
    stage2 = lowpass(1,6531.0) : *(gain1) : tubestage(1,194.0,820.0);
...
tubeax(preamp,gain1) = hgroup("amp2", hgroup("stage1", stage1) :
    ...
    stage1 = *(preamp): tubestage(0,86.0,2700.0): *(0.77) :
    lowpass(1,6531.0) : *(preamp) : tubestage(1,132.0,1500.0): *(0.77);
    stage2 = lowpass(1,6531.0) : *(gain1) : bifilter : tubestage(1,194.0,820.0) : *(0.77);
