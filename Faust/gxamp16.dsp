...
*/
     ...
     *(preamp) : (tubestg(TB_12AT7_68k,86.0,2700.0,2.617753) : + ~ (atten*tubestg(TB_12AT7_250k,132.0,1500.0,1.887333))):
    fi.lowpass(1,6531.0) : (tubestg(TB_12AT7_250k,132.0,1500.0,1.887333) : + ~ (atten*tubestg(TB_12AT7_250k,194.0,820.0,1.256962))) : tubestg(TB_12AT7_250k,194.0,820.0,1.256962);
