...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "preampmono");
		m->declare("filters.lib/name", "Faust Filters Library");
		m->declare("filters.lib/version", "0.0");
		m->declare("id", "RedeyePreMono");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "RedeyePreMono");
	}
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst13 = std::tan((1507.96448f / fConst0));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("RedeyePreMono");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = ((((fConst19 * fRec15[0]) + (fConst26 * fRec15[1])) + (fConst19 * fRec15[2])) + ((fRec17[2] + (fRec17[0] + (2.0f * fRec17[1]))) * std::pow(10.0f, (0.0f - (1.20000005f * fRec19[0])))));
			fVec0[0] = fTemp0;
			fRec14[0] = ((fConst15 * ((fConst17 * fTemp0) + (fConst27 * fVec0[1]))) - (fConst29 * fRec14[1]));
			fRec13[0] = (fRec14[0] - (fConst10 * ((fConst30 * fRec13[2]) + (fConst31 * fRec13[1]))));
			fRec20[0] = (fSlow4 + (0.999000013f * fRec20[1]));
			fRec22[0] = (0.0f - (fConst33 * ((fConst28 * fRec22[1]) - (fConst15 * (fTemp0 + fVec0[1])))));
			fRec21[0] = (fRec22[0] - (fConst10 * ((fConst30 * fRec21[2]) + (fConst31 * fRec21[1]))));
			float fTemp1 = (((fRec10[0] * fRec11[0]) * float(input0[i])) - (fConst10 * (fRec12[0] * (((((fConst12 * fRec13[0]) + (fConst32 * fRec13[1])) + (fConst12 * fRec13[2])) * std::pow(10.0f, (0.0f - (1.20000005f * fRec20[0])))) + (fRec21[2] + (fRec21[0] + (2.0f * fRec21[1])))))));
			fVec1[0] = fTemp1;
			fRec9[0] = ((0.930284798f * (fTemp1 + fVec1[1])) - (0.860569596f * fRec9[1]));
