 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec27[0] = (float(Ftube(int(TUBE_TABLE_12AT7_250k), float((((0.925449848f * (fRec28[0] + fRec28[2])) + (fRec30[0] + (1.8508997f * fRec28[1]))) + -1.25696194f)))) + -96.7119522f);
			...
			fRec38[0] = (float(Ftube(int(TUBE_TABLE_12AT7_250k), float((((0.925449848f * (fRec39[0] + fRec39[2])) + (fRec41[0] + (1.8508997f * fRec39[1]))) + -1.88733304f)))) + -124.177803f);
			...
			fRec43[0] = (float(Ftube(int(TUBE_TABLE_12AT7_68k), float((((0.925449848f * (fRec44[0] + fRec44[2])) + (fRec51[0] + (1.8508997f * fRec44[1]))) + -2.61775303f)))) + -153.046188f);
			...
			fRec32[0] = (float(Ftube(int(TUBE_TABLE_12AT7_250k), float((((0.925449848f * (fRec33[0] + fRec33[2])) + (fRec52[0] + (1.8508997f * fRec33[1]))) + -1.88733304f)))) + -124.177803f);
			...
			fRec22[0] = (float(Ftube(int(TUBE_TABLE_12AT7_250k), float((((0.925449848f * (fRec23[0] + fRec23[2])) + (fRec53[0] + (1.8508997f * fRec23[1]))) + -1.25696194f)))) + -96.7119522f);
