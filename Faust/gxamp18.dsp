...
tubeax(preamp,gain1) =  hgroup("stage1", stage1) :
          ...
          with {
    stage1 = tubestg(TB_6C16_68k,86.0,2700.0,2.921806) : *(preamp):
    fi.lowpass(1,6531.0) : tubestg(TB_6C16_250k,132.0,1500.0,2.097743) : *(preamp);
    stage2 = fi.lowpass(1,6531.0) : tubestg(TB_6C16_250k,194.0,820.0,1.378742) : *(gain1); 
};
