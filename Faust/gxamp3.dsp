...
tubeax(preamp,gain1) =  hgroup("stage1", stage1) :
    ...
    stage1 = tubestg(TB_12AU7_68k,86.0,2700.0,3.718962) : *(preamp):*(2.0):
    fi.lowpass(1,6531.0) : tubestg(TB_12AU7_250k,132.0,1500.0,2.314844) : *(preamp) :*(2.0);
    stage2 = fi.lowpass(1,6531.0) : tubestg(TB_12AU7_250k,194.0,820.0,1.356567) : *(gain1):*(2.0); 
