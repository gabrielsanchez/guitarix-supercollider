...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("id", "pre 12AU7/ master 6V6");
		...
		m->declare("name", "pre 12AU7/ master 6V6");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("pre 12AU7/ master 6V6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec23[0] = (float(Ftube(int(TUBE_TABLE_12AU7_68k), float((((0.925449848f * (fRec24[0] + fRec24[2])) + (fRec27[0] + (1.8508997f * fRec24[1]))) + -1.25724006f)))) + -83.4355545f);
			fRec22[0] = ((0.100000001f * ((fConst4 * fRec23[0]) + (fConst27 * fRec23[1]))) - (fConst28 * fRec22[1]));
			...
			fRec18[0] = (float(Ftube(int(TUBE_TABLE_12AU7_250k), float((((0.925449848f * (fRec19[0] + fRec19[2])) + (fRec28[0] + (1.8508997f * fRec19[1]))) + -0.776162028f)))) + -78.255867f);
			fRec17[0] = ((0.100000001f * ((fConst4 * fRec18[0]) + (fConst27 * fRec18[1]))) - (fConst28 * fRec17[1]));
			...
			fRec14[0] = (float(Ftube(int(TUBE_TABLE_12AU7_250k), float((((0.925449848f * (fRec15[0] + fRec15[2])) + (fRec29[0] + (1.8508997f * fRec15[1]))) + -0.445486993f)))) + -75.6723175f);
			fRec13[0] = ((0.100000001f * ((fConst4 * fRec14[0]) + (fConst27 * fRec14[1]))) - (fConst28 * fRec13[1]));
