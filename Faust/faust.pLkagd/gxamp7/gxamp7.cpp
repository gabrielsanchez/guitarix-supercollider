...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("id", "pre 12ax7/ push-pull 6V6");
		...
		m->declare("name", "pre 12ax7/ push-pull 6V6");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("pre 12ax7/ push-pull 6V6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec27[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec28[0] + fRec28[2])) + (fRec30[0] + (1.8508997f * fRec28[1]))) + -0.840703011f)))) + -147.47525f);
			fRec26[0] = ((0.0250000004f * ((fConst4 * fRec27[0]) + (fConst27 * fRec27[1]))) - (fConst28 * fRec26[1]));
			...
			fRec38[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec39[0] + fRec39[2])) + (fRec41[0] + (1.8508997f * fRec39[1]))) + -1.20428503f)))) + -169.71434f);
			fRec37[0] = ((0.0250000004f * ((fConst4 * fRec38[0]) + (fConst27 * fRec38[1]))) - (fConst28 * fRec37[1]));
			...
			fRec43[0] = (float(Ftube(int(TUBE_TABLE_12AX7_68k), float((((0.925449848f * (fRec44[0] + fRec44[2])) + (fRec51[0] + (1.8508997f * fRec44[1]))) + -1.58165598f)))) + -191.420151f);
			fRec42[0] = ((0.0250000004f * ((fConst4 * fRec43[0]) + (fConst27 * fRec43[1]))) - (fConst28 * fRec42[1]));
			...
			fRec32[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec33[0] + fRec33[2])) + (fRec52[0] + (1.8508997f * fRec33[1]))) + -1.20428503f)))) + -169.71434f);
			fRec31[0] = ((0.0250000004f * ((fConst4 * fRec32[0]) + (fConst27 * fRec32[1]))) - (fConst28 * fRec31[1]));
			...
			fRec22[0] = (float(Ftube(int(TUBE_TABLE_12AX7_250k), float((((0.925449848f * (fRec23[0] + fRec23[2])) + (fRec53[0] + (1.8508997f * fRec23[1]))) + -0.840703011f)))) + -147.47525f);
			fRec21[0] = ((0.0250000004f * ((fConst4 * fRec22[0]) + (fConst27 * fRec22[1]))) - (fConst28 * fRec21[1]));
